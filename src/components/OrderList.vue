<template>
  <div class="uc-box uc-main-box">
    <div class="uc-content-box order-list-box">
      <div class="box-hd"><h1 class="title">
        我的订单<small>请谨防钓鱼链接或诈骗电话，<a href="//www.mi.com/service/buy/Avoid%20Fraud/" target="_blank"
                                   data-stat-id="1dcad210d69d2f73"
                                   onclick="_msq.push(['trackEvent','31fc3d04217bf050-1dcad210d69d2f73','//www.mi.com/service/buy/Avoid%20Fraud/','pcpid','undefined']);">了解更多&gt;</a></small>
      </h1>
        <div class="more clearfix">
          <ul class="filter-list">
            <li class="first active"><a data-stat-id="57897755adc8c1e0" href="javascript:void(0);">全部有效订单</a></li>
            <li class=""><a href="javascript:void(0);" data-stat-id="3b01a603041ec976"
                            onclick="_msq.push(['trackEvent','31fc3d04217bf050-3b01a603041ec976','javascript:void(0);','pcpid','undefined']);">
              待支付
            </a></li>
            <li class=""><a href="javascript:void(0);" data-stat-id="871a024b6d0bdd56"
                            onclick="_msq.push(['trackEvent','31fc3d04217bf050-871a024b6d0bdd56','javascript:void(0);','pcpid','undefined']);">
              待收货
            </a></li>
            <li class=""><a data-stat-id="1591d5f9a89e8bb6" href="javascript:void(0);">订单回收站</a></li>
          </ul>
          <div class="search-form clearfix"><label for="search" class="hide">站内搜索</label><input type="search"
                                                                                                name="keywords"
                                                                                                autocomplete="off"
                                                                                                placeholder="输入商品名称、订单号"
                                                                                                class="search-text"><input
                  type="button" value="" class="search-btn iconfont"></div>
        </div>
      </div>
      <div class="box-bd">
        <div class="order">
...
<style scoped>
  ...
  @media (-ms-high-contrast: none) {
    .loader, .loader ::-ms-backdrop, .loader:after, .loader:before {
      animation: none
    }
  }
  ...
  .cancel-order-dialog .mi-dialog__body {
    position: relative;
    max-height: 400px;
  ...
  .mi-pagenav[data-v-0acc30d3] {
    height: 30px;
    padding: 15px 0;
    text-align: center
  }

  .mi-pagenav .numbers[data-v-0acc30d3] {
    display: inline-block;
    width: 48px;
    height: 24px;
    padding: 3px 0;
  ...
  .mi-pagenav .iconfont[data-v-0acc30d3] {
    font-size: 24px;
    vertical-align: bottom
  }

  .mi-pagenav a.numbers[data-v-0acc30d3] {
    -webkit-transition: all .2s linear;
    transition: all .2s linear
  }

  .mi-pagenav a.numbers[data-v-0acc30d3]:hover {
    background: #b0b0b0;
    color: #fff
  }

  .mi-pagenav .current[data-v-0acc30d3] {
    background-color: #757575;
    color: #fff
  }
  ...
  .qrcode-wrapper .imgCode[data-v-9aef8a0c] {
    width: 160px;
    margin: 0 auto 10px;
    min-height: 170px
  }

  .qrcode-wrapper img[data-v-9aef8a0c] {
    display: block;
    margin: 0 auto;
    width: 160px;
    height: 170px
  ...
  .trading-snapshot-link[data-v-1e04aab1] {
    margin-left: 6px
  }

  .flag-gift[data-v-9b301396] {
    color: #fff;
    background-color: #e53935
  }

  .flag[data-v-9b301396] {
    position: absolute;
    right: -1px;
    top: -1px;
    padding: 0 16px;
  ...
  .flag:hover .popup-tip[data-v-9b301396] {
    display: block
  }

  .popup-tip[data-v-9b301396] {
    display: none;
    position: absolute;
    top: 30px;
    right: -48px;
  ...
  .popup-tip[data-v-9b301396]:before {
    position: absolute;
    top: -5px;
    left: 190px;
    width: 9px;
    height: 5px;
    content: "";
    background: url(//s02.mifile.cn/assets/static/image/tip-arrow.png) no-repeat 50% 0
  }

  .tag-package[data-v-9b301396] {
  ...
  .tag[data-v-9b301396], .tri[data-v-9b301396] {
    display: inline-block;
    *zoom: 1;
    *display: inline;
    vertical-align: middle
  ...
  .delivery-link[data-v-9b301396] {
    color: #333;
    cursor: pointer
  }

  .delivery-link[data-v-9b301396]:hover {
    color: #ff6700
  }

  .delivery-link:hover .tri[data-v-9b301396] {
    border-top-color: #ff6700
  }

  .order-delivery[data-v-9b301396] {
    padding: 0 20px 12px;
    margin: 15px 0 20px;
  ...
  .order-delivery .delivery-num[data-v-9b301396] {
    line-height: 30px;
    border-bottom: 1px solid #cfeeab
  }

  .order-delivery .delivery-num a[data-v-9b301396] {
    margin-right: 10px
  }

  .order-delivery .delivery-num .iconfont[data-v-9b301396] {
    font-size: 14px;
    line-height: 14px;
    vertical-align: text-bottom
  }

  .order-delivery .delivery-list-wrapper[data-v-9b301396] {
    height: 105px;
    overflow: auto
  }

  .order-delivery .delivery-list-wrapper .delivery-list[data-v-9b301396] {
    margin: 0;
    padding: 0;
    list-style-type: none
  }

  .order-delivery .delivery-list-wrapper .delivery-list li[data-v-9b301396] {
    position: relative;
  ...
  .order-delivery .delivery-list-wrapper .delivery-list li[data-v-9b301396]:before {
    position: absolute;
    top: 0;
    left: 3px;
    width: 1px;
  ...
  .order-delivery .delivery-list-wrapper .delivery-list li[data-v-9b301396]:after {
    position: absolute;
    top: 11px;
    left: 0;
    width: 7px;
  ...
  .order-delivery .delivery-list-wrapper .delivery-list li[data-v-9b301396]:first-child:before {
    top: 15px
  }

  .order-delivery .delivery-list-wrapper .delivery-list li[data-v-9b301396]:first-child:after {
    background-color: #83c44e
  }

  .order-delivery .delivery-list-wrapper .delivery-list li[data-v-9b301396]:last-child:before {
    height: 15px
  }

  .order-delivery .delivery-list-wrapper .delivery-list li.empty[data-v-9b301396] {
    padding: 0;
    font-size: 14px;
    text-align: center;
    margin: 40px 0;
  ...
  .order-delivery .delivery-list-wrapper .delivery-list li.empty[data-v-9b301396]:after, .order-delivery .delivery-list-wrapper .delivery-list li.empty[data-v-9b301396]:before {
    display: none
  }

  .order-delivery .delivery-list-wrapper .delivery-list li.loading[data-v-9b301396] {
    padding: 42px 0
  }

  .order-delivery .delivery-list-wrapper .delivery-list li.loading[data-v-9b301396]:after, .order-delivery .delivery-list-wrapper .delivery-list li.loading[data-v-9b301396]:before {
    display: none
  }

  .order-list-box .order-desc[data-v-9b301396] {
    margin: 2px 0 0
  }

  .order-list-box .comments[data-v-9b301396] {
    border: 1px solid #f60;
    color: #f60
  }

  .order-list-box .comments[data-v-9b301396]:hover {
    color: #fff;
    background: #f60;
    border: 1px solid #f60
  }
  ...
  .uc-box .uc-content-box .box-hd small {
    margin-left: 10px;
    font-size: 12px;
    line-height: 1.5
  }

  .uc-box .uc-content-box .box-hd small a {
    color: #757575
  }
  ...
  .uc-box .uc-content-box .box-hd .search-text {
    right: 41px;
    z-index: 1;
    width: 189px;
    height: 40px;
  ...
  .order-list-box .order-list .uc-order-item-finish .order-desc, .order-list-box .order-list .uc-order-item-finish .order-status {
    color: #b0b0b0
  }
  ...
  .order-list-box .order-list .uc-order-item-shipping .order-desc, .order-list-box .order-list .uc-order-item-shipping .order-status {
    color: #83c44e
  }
  ...
  .restore-order .el-dialog__footer .btn-gray {
    display: none
  }
  ...
  .urge-order .el-dialog__footer {
    display: none
  }

  .urge-order .confirm-msg h3 {
    margin: 0 !important;
  ...
  .mi-uc-box .box-hd .filter-list li.active, .mi-uc-box .box-hd .filter-list li.active a {
    color: #ff6700
  }
  ...
  .portal-content-box .portal-main[data-v-6cfb7de2] {
    padding-top: 24px
  }

  .portal-content-box .user-card[data-v-6cfb7de2] {
    position: relative;
    float: left;
    width: 302px;
    height: 160px;
  ...
  .portal-content-box .user-card .avatar[data-v-6cfb7de2] {
    position: absolute;
    left: 0;
    top: 0;
    padding: 4px;
  ...
  .portal-content-box .user-card .username[data-v-6cfb7de2] {
    margin: 0;
    font-size: 24px;
    font-weight: 400;
    color: #616161
  ...
  .portal-content-box .user-card .tip[data-v-6cfb7de2] {
    margin: 0 0 10px;
    color: #b0b0b0
  }

  .portal-content-box .user-card .link[data-v-6cfb7de2] {
    font-size: 12px;
    color: #ff6700
  }

  .portal-content-box .user-actions[data-v-6cfb7de2] {
    float: right;
    width: 358px;
    margin-top: 35px
  }

  .portal-content-box .user-actions .action-list[data-v-6cfb7de2] {
    margin: 0;
    padding: 0;
    list-style-type: none;
    color: #757575
  ...
  .portal-content-box .user-actions .action-list li[data-v-6cfb7de2] {
    position: relative;
    padding: 6px 0
  }

  .portal-content-box .user-actions .action-list .btn[data-v-6cfb7de2] {
    position: absolute;
    right: 0;
    top: 0
  }

  .portal-content-box .user-actions .action-list .level-1[data-v-6cfb7de2] {
    color: #e53935
  }

  .portal-content-box .user-actions .action-list .level-2[data-v-6cfb7de2] {
    color: #ffac13
  }

  .portal-content-box .user-actions .action-list .level-3[data-v-6cfb7de2] {
    color: #83c44e
  }

  .portal-sub[data-v-1ace6eb7] {
    border-top: 1px solid #e0e0e0
  }

  .portal-sub .info-list[data-v-1ace6eb7] {
    margin: 0;
    padding: 60px 0 0;
    list-style-type: none;
    color: #757575
  ...
  .portal-sub .info-list li[data-v-1ace6eb7] {
    position: relative;
    float: left;
    width: 276px;
    height: 65px;
  ...
  .portal-sub .info-list h3[data-v-1ace6eb7] {
    margin: 0;
    font-size: 18px;
    font-weight: 400
  }

  .portal-sub .info-list .num[data-v-1ace6eb7] {
    color: #ff6700
  }

  .portal-sub .info-list .iconfont[data-v-1ace6eb7] {
    font-size: 16px;
    line-height: 16px;
    vertical-align: -1px
  }

  .portal-sub .info-list img[data-v-1ace6eb7] {
    position: absolute;
    left: -10px;
    top: -10px
  }
  ...
  .home-tool-bar .item[data-v-9533281e] {
    position: relative;
    display: block;
    width: 82px;
    height: 90px;
  ...
  .home-tool-bar .item:hover .text[data-v-9533281e] {
    color: #ff6700
  }

  .home-tool-bar .item:hover .static[data-v-9533281e] {
    opacity: 0
  }

  .home-tool-bar .item:hover .hover[data-v-9533281e] {
    opacity: 1
  }

  .home-tool-bar .item:hover .pop-content[data-v-9533281e] {
  ...
  .home-tool-bar .item .icon[data-v-9533281e] {
    position: relative;
    width: 30px;
    height: 30px;
    margin: 0 auto 8px;
  ...
  .home-tool-bar .item .icon img[data-v-9533281e] {
    position: absolute;
    bottom: 0;
    left: 0;
    width: 30px;
  ...
  .home-tool-bar .item .static[data-v-9533281e] {
    opacity: 1
  }

  .home-tool-bar .item .hover[data-v-9533281e] {
    opacity: 0
  }

  .home-tool-bar .item .text[data-v-9533281e] {
    color: #757575;
    -webkit-transition: color .3s;
    transition: color .3s
  }

  .home-tool-bar .item .pop-content[data-v-9533281e] {
    position: absolute;
    left: 0;
    top: 0;
    padding: 14px;
  ...
  .home-tool-bar .item .pop-content[data-v-9533281e]:after, .home-tool-bar .item .pop-content[data-v-9533281e]:before {
    content: "";
    position: absolute;
    top: 21%;
    width: 0;
  ...
  .home-tool-bar .item .pop-content[data-v-9533281e]:after {
    right: -18px;
    border-color: rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #fff;
    z-index: 2
  }

  .home-tool-bar .item .pop-content[data-v-9533281e]:before {
    right: -19px;
    border-color: rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #f5f5f5;
    z-index: 1
  }

  .home-tool-bar .item .pop-content img[data-v-9533281e] {
    display: block;
    width: 100px;
    height: 100px;
    margin: 6px auto
  ...
  .home-tool-bar .item .pop-content .desc[data-v-9533281e] {
    display: block;
    width: 82px;
    margin: 14px auto 0;
    color: #757575;
  ...
  .home-tool-bar .item .cart-num[data-v-9533281e] {
    position: absolute;
    right: 14px;
    top: 18px;
    padding: 0 5px;
  ...
  .home-tool-bar .backtop[data-v-9533281e] {
    margin-top: 14px;
    border-top: 1px solid #f5f5f5;
    visibility: hidden
  }

  .home-tool-bar .backtop.active[data-v-9533281e] {
    visibility: visible
  }

  .home-tool-bar-small[data-v-9533281e] {
    left: 50%;
    right: auto;
    margin-left: 613px;
    bottom: 40px
  ...
  .home-tool-bar-small.mini[data-v-9533281e] {
    right: 0;
    left: auto;
    margin-left: 0
  }

  .home-tool-bar-small .item[data-v-9533281e] {
    width: 25px;
    height: 40px
  }

  .home-tool-bar-small .item:hover .text[data-v-9533281e] {
    display: block;
  ...
  .home-tool-bar-small .item-image:hover .text[data-v-9533281e] {
    display: none
  }

  .home-tool-bar-small .item .icon[data-v-9533281e] {
    width: 20px;
    height: 20px;
    padding-top: 10px
  }

  .home-tool-bar-small .item .icon img[data-v-9533281e] {
    width: 20px;
    height: 20px
  }

  .home-tool-bar-small .item .text[data-v-9533281e] {
    display: none;
    position: absolute;
    left: 0;
    top: 50%;
  ...
  .home-tool-bar-small .item .text[data-v-9533281e]:after, .home-tool-bar-small .item .text[data-v-9533281e]:before {
    content: "";
    position: absolute;
    top: 50%;
    width: 0;
  ...
  .home-tool-bar-small .item .text[data-v-9533281e]:after {
    border-color: rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #fff;
    right: -12px;
    z-index: 2
  }

  .home-tool-bar-small .item .text[data-v-9533281e]:before {
    border-color: rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) rgba(0, 0, 0, 0) #f5f5f5;
    right: -13px;
    z-index: 1
  }

  .home-tool-bar-small .item .text i[data-v-9533281e] {
    font-style: normal
  }

  .home-tool-bar-small .item .pop-content[data-v-9533281e]:after, .home-tool-bar-small .item .pop-content[data-v-9533281e]:before {
    top: 10px;
    border-width: 6px
  }

  .home-tool-bar-small .item .pop-content[data-v-9533281e]:after {
    right: -12px
  }

  .home-tool-bar-small .item .pop-content[data-v-9533281e]:before {
    right: -13px
  }

  .home-tool-bar-small .item .cart-num[data-v-9533281e] {
    right: 0;
    top: 8px;
    width: 6px;
    height: 6px;
