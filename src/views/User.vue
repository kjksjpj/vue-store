<template>
  <div class="html">
    <div class="body">
      <div class="container ">
        <div class="row" style="display: flex;margin: 10px 30px 10px 0px;">

          <!--左侧导航栏区-->
          <div class="span4"  style="border:#1b1f23 solid;">
            <div id="J_userMenu" class="user-address-menu">
              <div class="menu-box">
                <h3 class="title" id="titile" style="font-size: 25px;">购物商城</h3>
                <ul class="list">
<!--                  <li :class="{active:isActive==1}"><a href="javascript:void(0);" data-stat-id="e90282590ad08689"-->
<!--                                                       v-on:click="$router.push({ path: '/order' }),isActive=1">-->
<!--                    我的订单</a>-->
<!--                  </li>-->
...
<!--                  </li>-->
              ...
              <div class="menu-box">
                <h3 class="title" style="font-size: 25px;">个人中心</h3>
                <ul class="list">
                  <li :class="{active:isActive==5}">
                    <a href="javascript:void(0);" data-stat-id="e90282590ad08689" v-on:click="$router.push({ path: '/user/profile' }),isActive=5">个人信息</a>
                  </li>
                  <li :class="{active:isActive==6}">
                    <a href="javascript:void(0);" data-stat-id="e90282590ad08689" v-on:click="$router.push({ path: '/user/distribution' }),isActive=6">分销中心</a>
                  </li>
...
<!--                  </li>-->
                  <li :class="{active:isActive==13}">
                    <a href="javascript:void(0);" data-stat-id="e90282590ad08689" v-on:click="$router.push({ path: '/user/address' }),isActive=13">收货地址</a>
                  </li>
                  <li :class="{active:isActive==14}">
                    <a href="javascript:void(0);" data-stat-id="9a8ab8414891ff85" v-on:click="$router.push({ path: '/orderList' }),isActive=14">我的订单</a>
                  </li>
                </ul>
              </div>
              ...
              <div class="menu-box">
                <h3 class="title" style="font-size: 25px;">销售口号</h3>
                <ul class="list">
                  <li><a data-stat-id="188ed0acb57d9f29">用心专业</a>
                  </li>
                  <li><a data-stat-id="2d85df39710f9f5b">客户至上</a>
                  </li>
                </ul>
              </div>
              <el-divider></el-divider>
              <div class="menu-box">
                <h3 class="title" style="font-size: 25px;">服务宗旨</h3>
                <ul class="list">
                  <li>
                    <a  data-stat-id="e90282590ad08689">
                    高品质</a>
                  </li>
                  <li><a data-stat-id="515f6286408eef63">高服务</a>
                  </li>
                </ul>
              </div>
            </div>
