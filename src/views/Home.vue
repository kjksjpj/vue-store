    ...
    <div class="block">
      <el-carousel  height="300px">
        <el-carousel-item v-for="item in carousel" :key="item.carousel_id">
          <img style="height:300px;" :src="item.img" :alt="item.describes"/>
        </el-carousel-item>
      </el-carousel>
    </div>
    <!-- 轮播图END -->
...
<!--&lt;!&ndash;              <MyMenu :val="2" @fromChild="getChildMsg">&ndash;&gt;-->
<!--&lt;!&ndash;                <span slot="1">热门</span>&ndash;&gt;-->
<!--&lt;!&ndash;                <span slot="2">电视影音</span>&ndash;&gt;-->
<!--&lt;!&ndash;              </MyMenu>&ndash;&gt;-->
<!--            </div>-->
<!--          </div>-->
<!--          <div class="box-bd">-->
